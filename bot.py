...
async def start(event):
  await event.reply("**FearlessRise_TagBot Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/FearlessRise_TagBot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/FearlessRise'),
...
print(">> Bot çalıyor merak etme 🚀 @Samiilben bilgi alabilirsin <<")
